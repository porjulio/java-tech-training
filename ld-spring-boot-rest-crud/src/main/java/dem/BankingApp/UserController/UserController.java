...
import dem.BankingApp.UserRepository.UserRepository;
...
public class UserController {
	...
	protected String getAllUsersAsHtml() {
		...
		for(UserInfo user : userInfoList) {
			usersHTML += "<tr><td>"+ user.getuserId()+ "</td><td>" + user.getUserNameString() + "</td><td>" + user.getUserPassword() + "</td><td>" + user.getCreateDate() + "</td>"
	...
	@DeleteMapping("users/{userIdFromBrowser}")
		public void deleteUser(@PathVariable(value="userIdFromBrowser")Long userId)
		{
